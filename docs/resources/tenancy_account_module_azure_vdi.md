...
hide: toc
page_title: "volocloud_tenancy_account_module_azure_vdi Resource"
subcategory: ""
---
...
- `account_id` (String) Volocloud Account ID associated with this tenancy_account_module.
...
- `module_id` (String) Volocloud Tenancy Account Module Azure VDI ID.
...
- `encryption_at_host` (Boolean) If enabled, it will encrypt all the disks (including the temp disk) attached to the host pool session host VM(s) by enabling Encryption at Host. Defaults to `false`.
